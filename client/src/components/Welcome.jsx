...
export default function Welcome() {
  //Calling the Value parameter passed as a context in a Destructured manner;
  ...
  return (
    <div id="home" className="w-full flex justify-center items-center">
      <div className="flex text-white md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          <h1 className="text-3xl text-gradient sm:text-5xl py-1">
            Send Crypto <br /> across the World
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the Crypto Worl. Buy & Sell Cryptocyrrencies easily on
            Krypto.
          </p>
          {!currentAccount && (
            <button
        ...
        <div className="flex flex-1 flex-col items-center justify-start w-full md:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-9/12 w-full my-5 eth-card white-glassmorphism">
